...
public class regactivityCB extends AppCompatActivity {
    ...
    EditText Bname,ptmbno,ptmail,ptcpass,ptpass,ptage;
    RadioGroup ptgender;
    Button register;
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            CarBuyer CB = new CarBuyer(name, mbno, mail, cpass,  age, gender);
                             ...
                             .setValue(CB).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Intent intent = new Intent(regactivityCB.this, fragment1.class);
